...
const showPlaylist = function() {
    ...
    playlist.forEach((playlist)=>{
        ...
        <a href="#" class="link-secondary link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover">${playlist}</a>
        `
